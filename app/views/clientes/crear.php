    ...
    <div class="col-lg-8">
        <div class="card shadow-sm border-0">
            <div class="card-body p-4">
                ...
                <p class="text-muted">Complete el formulario para registrar un cliente.</p>

                <?php if (!empty($errors['general'])): ?>
                    <div class="alert alert-danger"><?= htmlspecialchars($errors['general']) ?></div>
                <?php endif; ?>

                <form method="POST" action="index.php?controller=cliente&action=guardar" class="needs-validation cliente-form" novalidate>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="cedula" class="form-label">Cedula</label>
                            <input type="text" class="form-control" id="cedula" name="cedula" maxlength="10" value="<?= htmlspecialchars($old['cedula']) ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="telefono" name="telefono" maxlength="10" value="<?= htmlspecialchars($old['telefono']) ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="nombres" name="nombres" value="<?= htmlspecialchars($old['nombres']) ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="apellidos" name="apellidos" value="<?= htmlspecialchars($old['apellidos']) ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control" id="correo" name="correo" value="<?= htmlspecialchars($old['correo']) ?>" required>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" id="direccion" name="direccion" rows="3" required><?= htmlspecialchars($old['direccion']) ?></textarea>
