    ...
    <div class="col-lg-8">
        <div class="card shadow-sm border-0">
            <div class="card-body p-4">
                <h1 class="h3 mb-3">Editar moto</h1>
                <p class="text-muted">Actualice los datos de la moto seleccionada.</p>

                <?php if (!empty($errors['general'])): ?>
                    <div class="alert alert-danger"><?= htmlspecialchars($errors['general']) ?></div>
                <?php endif; ?>

                <form method="POST" action="index.php?controller=moto&action=actualizar" class="needs-validation moto-form" novalidate>
                    <input type="hidden" name="id_moto" value="<?= htmlspecialchars((string) $moto['id_moto']) ?>">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="id_cliente" name="id_cliente" required>
                                ...
                                <?php foreach ($clientes as $cliente): ?>
                                    <option value="<?= htmlspecialchars((string) $cliente['id_cliente']) ?>" <?= (string) $moto['id_cliente'] === (string) $cliente['id_cliente'] ? 'selected' : '' ?>>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="placa" name="placa" maxlength="10" value="<?= htmlspecialchars($moto['placa']) ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="marca" name="marca" value="<?= htmlspecialchars($moto['marca']) ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="modelo" name="modelo" value="<?= htmlspecialchars($moto['modelo']) ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="anio" name="anio" min="1990" max="<?= htmlspecialchars((string) $currentYear) ?>" value="<?= htmlspecialchars((string) $moto['anio']) ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="color" name="color" value="<?= htmlspecialchars($moto['color']) ?>" required>
